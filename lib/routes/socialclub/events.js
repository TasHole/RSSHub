...
module.exports = async (ctx) => {
    ...
    const baseUrl = `https://ja-JP.socialclub.rockstargames.com/events/eventlisting?pageId=1&gameId=${gameId}`;
    // R星的傻逼防爬
    ...
    ctx.state.data = {
        ...
        link: 'https://ja-JP.socialclub.rockstargames.com/events?gameId=' + gameId,
        item:
            events &&
            events.map((x) => ({
                title: x.headerText,
                ...
                link: `https://ja-JP.socialclub.rockstargames.com/events/${x.urlHash}/${x.slug}/1`,
            })),
    };
};
